...
<div class="auth-wrapper">
	<div class="auth-content">
		<div class="card">
            ...
            <h4 class="mb-3 f-w-400">Réinitialisation</h4>
            <form class="form-horizontal" role="form" method="POST" action="{{  route('password.request')  }}">
              ...
              <div class="form-group mb-4 {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                <label class="floating-label" for="Password">Confirmer Mot de Passe</label>
                <input type="password" class="form-control" placeholder="Password" id="password_confirm" name="password_confirmation" required>
              ...
              <button type="submit" class="btn btn-block btn-primary mb-4">Réinitialiser</button>
            </form>
					</div>
				</div>
			</div>
