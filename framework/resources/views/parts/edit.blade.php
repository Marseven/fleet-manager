        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('parts.index')}}"><i class="feather icon-cpu"></i></a></li>
                    <li class="breadcrumb-item active"><a href="#">@lang('fleet.editParts')</a></li>
                </ul>
            </div>
        </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            {!! Form::select('status',["Active"=>"Active","Pending"=>"Pending", "Processing"=>"Processing", "Completed"=>"Completed","Hold"=>"Hold"],$data->status,['class' => 'form-control','required']) !!}
          </div>
          <div class="form-group">
            {!! Form::label('availability', __('fleet.availability') , ['class' => 'form-label']) !!}<br>
            <input type="radio" name="availability" class="flat-red gender" value="1" @if($data->availability == 1) checked @endif> @lang('fleet.available') &nbsp; &nbsp;

            <input type="radio" name="availability" class="flat-red gender"  value="0" @if($data->availability == 0) checked @endif> @lang('fleet.not_available')
          </div>
          <hr>
          <div class="form-group">
