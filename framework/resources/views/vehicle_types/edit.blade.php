        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('vehicle-types.index')}}"><i class="fa fa-car"></i></a></li>
                    <li class="breadcrumb-item active"><a href="#"> @lang('fleet.edit_vehicle_type')</a></li>
                </ul>
            </div>
        </div>
    </div>
