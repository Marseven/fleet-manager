        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"><?php echo app('translator')->getFromJson('fleet.serviceReminders'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <table id="base-style" class="table table-striped table-bordered nowrap">
          <thead>
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('fleet.last_performed'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php echo app('translator')->getFromJson('fleet.date'); ?>: <?php echo e($reminder->last_date); ?>

                <br>
                <?php echo app('translator')->getFromJson('fleet.meter'); ?>: <?php echo e($reminder->last_meter); ?>
              ...
              <td>
                ...
                <?php echo e($date = date('Y-m-d', strtotime($int, strtotime(date('Y-m-d'))))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fleet-manager-git/framework/resources/views/service_reminder/index.blade.php ENDPATH**/ ?>