        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"> <?php echo app('translator')->getFromJson('fleet.fuel'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <table id="base-style" class="table table-striped table-bordered nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <?php echo e($row->qty); ?> <?php echo app('translator')->getFromJson('fleet.gal'); ?> </td>
              <td>
                <?php ($total = $row->qty * $row->cost_per_unit); ?>
                <?php echo e(Hyvikk::get('currency')); ?> <?php echo e($total); ?>

                <br>
                <?php echo e(Hyvikk::get('currency')); ?> <?php echo e($row->cost_per_unit); ?>/<?php echo app('translator')->getFromJson('fleet.gallon'); ?>
              </td>
              <td>
              ...
              <td>
                <?php echo e($row->consumption); ?> <?php if(Hyvikk::get('dis_format') == "km"): ?> KMPG  <?php else: ?> MPG <?php endif; ?>
              </td>
              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fleet-manager-git/framework/resources/views/fuel/index.blade.php ENDPATH**/ ?>