      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php echo e(Hyvikk::get('app_name')); ?>
            ...
            <small class="pull-right"> <b><?php echo app('translator')->getFromJson('fleet.date'); ?> : </b> <?php echo e(date('d-m-Y')); ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
...
<?php /**PATH /Applications/MAMP/htdocs/fleet-manager-git/framework/resources/views/reports/print_delinquent.blade.php ENDPATH**/ ?>