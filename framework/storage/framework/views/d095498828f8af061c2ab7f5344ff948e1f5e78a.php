        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"><?php echo app('translator')->getFromJson('fleet.fuelReport'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
				...
				<table id="base-style" class="table table-striped table-bordered nowrap">
					...
					<?php $__currentLoopData = $fuel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td><?php echo e($f->consumption); ?> <?php if(Hyvikk::get('dis_format') == "km"): ?> KMPG  <?php else: ?> MPG <?php endif; ?></td>
							<td><?php echo e($f->qty * $f->cost_per_unit); ?> <?php echo e(Hyvikk::get('currency')); ?></td>
						</tr>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</tbody>
					<tfoot>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fleet-manager-git/framework/resources/views/reports/fuel.blade.php ENDPATH**/ ?>