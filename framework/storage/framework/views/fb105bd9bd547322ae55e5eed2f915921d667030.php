        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#"><i class="feather icon-droplet"></i></a></li>
                    <li class="breadcrumb-item active"><a href="#"><?php echo app('translator')->getFromJson('fleet.add_fuel'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-solid" >
              ...
              <div class="card-body">
                <div class="form-group">
                  <?php echo Form::label('qty',__('fleet.qty').' (Gal/liter)', ['class' => 'form-label']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/fleet-manager-git/framework/resources/views/fuel/create.blade.php ENDPATH**/ ?>